...
const perguntas =[
    ...
    alternativas[
  {
    ...
    afirmação"Você é objetivo(a) e direto(a), comunicando com clareza aquilo que realmente sabe. "
      ...
      {
        texto"B) contando histórias e enrolando nas dúvidas sobre você" ,
    ...
    alternativas[
  {
    ...
    afirmação"B) Está sempre em busca de aprender mais e se desenvolver continuamente."
  },
      {
        texto"B) Sim, mas apenas oq é exigido" ,
    ...
    alternativas[
  {
    ...
    alternativas[
  {
    texto"A) Esconder o erro e tentar resolver sozinho" ,
    afirmação"se mantém isolado evitando o julgamento e a ideia de errar"
  },
      {
        texto"B) Assumir e comunicar ao superiores" ,
